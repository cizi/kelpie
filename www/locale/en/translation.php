...
define("ENUM_EDIT_HEALT_TYPE", 'Type of health examination');
...
define("MATING_FORM_NOTE_2", "cover report for cover dog owners");
define("MATING_FORM_OWNER", "The owner of the covering dog is obliged to send the completed Covering sheet - report on covering to e-mail: chov-corgi@seznam.cz within 7 days after the covering. In the case of foreign mating, the filled form is sent by the owner of the bitch.");
...
define("LITTER_APPLICATION_REVIEW", "litter report for female owners");
define("LITTER_APPLICATION_REVIEW_2", "The owner of the female is obliged within 7 days after the litter, or within 75 days after mating if the female has not become pregnant, to send a completed Covering sheet - litter report to e-mail: chov-corgi@seznam.cz.");
