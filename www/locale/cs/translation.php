...
define("ENUM_EDIT_HEALT_TYPE", 'Typ zdr. vyšetření');
...
define("BLOCK_SETTING_ITEM_CONTENT_COLOR", 'Barva textu v bloku');
define("BLOCK_SETTING_ITEM_CONTENT_COLOR_REQ", 'Barva textu v bloku nesmí být prázdná!');
define("BLOCK_SETTING_ITEM_CONTENT_BG_COLOR", 'Barva pozadí bloku');
define("BLOCK_SETTING_ITEM_CONTENT_BG_COLOR_REQ", 'Barva pozadí bloku nesmí být prázdná!');
...
define("MATING_FORM_NOTE_2", "hlášení o krytí pro majitele krycího psa");
define("MATING_FORM_OWNER", "Majitel krycího psa je povinen do 7 dnů po krytí odeslat vyplněný Krycí list - hlášení o krytí na e-mail: chov-corgi@seznam.cz. Při zahraničním krytí posílá vyplněný formulář majitel feny.");
...
define("LITTER_APPLICATION_REVIEW", "hlášení o vrhu pro majitele feny");
define("LITTER_APPLICATION_REVIEW_2", "Majitel feny je povinen do 7 dnů po vrhu, nebo do 75 dní po krytí pokud fena nezabřezla, odeslat vyplněný Krycí list - hlášení o vrhu na e-mail: chov-corgi@seznam.cz.");
